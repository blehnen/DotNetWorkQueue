...
- SQLite transport: Add `EnableWalMode` option (default `true`) — new queues are automatically created with WAL journal mode for better concurrent read/write performance

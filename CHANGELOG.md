...
- LiteDb transport: no change to de-queue behaviour or to sends that carry a job name — both keep the process-wide lock they had, which is wider than strictly needed but is what guarantees a record cannot be claimed twice

...
namespace DotNetWorkQueue.Dashboard.Api.Integration.Tests.Tests
{
    public class SqliteEditBodyTests : IAsyncLifetime
    {
        ...
        {
            _processingHelper = new ConsumerStateHelper<SqLiteMessageQueueInit>();

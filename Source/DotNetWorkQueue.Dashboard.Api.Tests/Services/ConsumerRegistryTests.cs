...
namespace DotNetWorkQueue.Dashboard.Api.Tests.Services
{
    ...
    public class ConsumerRegistryTests
    {
            ...
            string connectionString = "memory")
        {
            ...
            typeof(DashboardQueueInfo).GetProperty("ConnectionString")!.SetValue(queueInfo, connectionString);
            ...
            typeof(DashboardConnectionInfo).GetProperty("ConnectionString")!.SetValue(connectionInfo, connectionString);
        ...
        public void Register_Returns_NonEmpty_Guid()
        {
            ...
            var id = registry.Register("testQueue", "memory", "MACHINE1", 1234, null);
        ...
        {
            var registry = CreateRegistry(out _);
            var id1 = registry.Register("testQueue", "memory", "MACHINE1", 1234, null);
            var id2 = registry.Register("testQueue", "memory", "MACHINE1", 5678, null);
            id1.Should().NotBe(id2);
        }

        [TestMethod]
        public void Register_Matches_Queue_By_Name_And_ConnectionString()
        {
            var registry = CreateRegistry(out var queueId);
            registry.Register("testQueue", "memory", "MACHINE1", 1234, null);
        ...
        {
            var registry = CreateRegistry(out _);
            registry.Register("otherQueue", "memory", "MACHINE1", 1234, null);
        ...
        [TestMethod]
        public void Register_No_Match_When_ConnectionString_Differs()
        {
            var registry = CreateRegistry(out _);
            registry.Register("testQueue", "other-connection", "MACHINE1", 1234, null);
        ...
        {
            var registry = CreateRegistry(out _);
            registry.Register("testQueue", "memory", "MACHINE1", 1234, "MyConsumer");
        ...
        public void GetAll_Returns_All_Registered()
        {
            var registry = CreateRegistry(out _);
            registry.Register("testQueue", "memory", "MACHINE1", 1234, null);
            registry.Register("testQueue", "memory", "MACHINE2", 5678, null);
        ...
        public void GetByQueue_Returns_Only_Matched()
        {
            var registry = CreateRegistry(out var queueId);
            registry.Register("testQueue", "memory", "MACHINE1", 1234, null);
            registry.Register("otherQueue", "memory", "MACHINE2", 5678, null);
        ...
        public void GetCountsByQueue_Returns_Counts()
        {
            ...
            registry.Register("testQueue", "memory", "MACHINE1", 1234, null);
            registry.Register("testQueue", "memory", "MACHINE2", 5678, null);
            registry.Register("otherQueue", "other", "MACHINE3", 9012, null);
        ...
        {
            var registry = CreateRegistry(out _);
            registry.Register("unknownQueue", "unknown", "MACHINE1", 1234, null);

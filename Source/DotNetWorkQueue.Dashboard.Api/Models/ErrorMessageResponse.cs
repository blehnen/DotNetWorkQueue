...
{
    /// <summary>
    /// Response model for an error message.
    /// </summary>
    public class ErrorMessageResponse
    {
        /// <summary>Gets or sets the error table primary key.</summary>
        ...
        /// <summary>Gets or sets the date/time of the last exception.</summary>

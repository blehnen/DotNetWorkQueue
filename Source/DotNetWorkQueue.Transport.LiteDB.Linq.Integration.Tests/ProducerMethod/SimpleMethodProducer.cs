...
namespace DotNetWorkQueue.Transport.LiteDb.Linq.Integration.Tests.ProducerMethod
{
    ...
    public class SimpleMethodProducer
    {
        ...
        [DataRow(100, true, true, true, false, false, IntegrationConnectionInfo.ConnectionTypes.Direct),
         ...
         DataRow(10, true, true, true, true, true, IntegrationConnectionInfo.ConnectionTypes.Memory),
            ...
            IntegrationConnectionInfo.ConnectionTypes connectionType)
        {
            using (var connectionInfo = new IntegrationConnectionInfo(connectionType))
            {
                ...
                consumer.Run<LiteDbMessageQueueInit, LiteDbMessageQueueCreation>(new QueueConnection(queueName,
                    ...
                    messageCount, interceptors, enableChaos, false, x => Helpers.SetOptions(x, enableDelayedProcessing, enableMessageExpiration, enableStatusTable),

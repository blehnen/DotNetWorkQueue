...
namespace DotNetWorkQueue.Transport.LiteDb.Basic.Command
{
    ...
    /// </summary>
    public class CreateQueueTablesAndSaveConfigurationCommand<TTableType>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateQueueTablesAndSaveConfigurationCommand{TTableType}"/> class.
        /// </summary>

...
namespace DotNetWorkQueue.Transport.LiteDb.Basic.Factory
{
    ...
    /// </summary>
    /// <seealso cref="DotNetWorkQueue.IReceiveMessagesFactory" />
    internal class LiteDbReceiveMessagesFactory : IReceiveMessagesFactory
    {
        private readonly IContainerFactory _container;
        /// <summary>
        /// Initializes a new instance of the <see cref="LiteDbReceiveMessagesFactory" /> class.
        /// </summary>

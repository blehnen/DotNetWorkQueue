...
namespace DotNetWorkQueue.Transport.LiteDb.Basic
{
    internal class LiteDbGetPreviousMessageErrors : IGetPreviousMessageErrors
    {
        ...
        #region Constructor        
        /// <summary>
        /// Initializes a new instance of the <see cref="LiteDbGetPreviousMessageErrors"/> class.
        /// </summary>
        ...
        public IReadOnlyDictionary<string, int> Get(IMessageId id)
        {
            return !id.HasValue
                ...
                : _getErrorMessageQueryHandler.Handle(new GetMessageErrorsQuery<int>(Convert.ToInt32(id.Id.Value)));
        }
        #endregion
    }
}

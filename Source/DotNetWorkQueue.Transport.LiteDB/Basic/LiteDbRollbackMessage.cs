...
namespace DotNetWorkQueue.Transport.LiteDb.Basic
{
    ...
    /// </summary>
    /// <seealso cref="DotNetWorkQueue.Transport.Shared.ITransportRollbackMessage" />
    internal class LiteDbRollbackMessage : ITransportRollbackMessage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LiteDbRollbackMessage"/> class.
        /// </summary>
        /// <param name="configuration">The configuration.</param>
        /// <param name="rollbackCommand">The rollback command.</param>
        /// <param name="headers">The headers.</param>
        public LiteDbRollbackMessage(QueueConsumerConfiguration configuration,

...
namespace DotNetWorkQueue.Transport.LiteDb.Tests.Basic.QueryHandler
{
    ...
    public class GetDashboardErrorRetriesQueryHandlerAsyncTests
    {
        ...
        public void Create_Default()
        {
            ...
            Assert.IsNotNull(new GetDashboardErrorRetriesQueryHandlerAsync(connectionManager, tableNameHelper));
        }
        ...
        public void Create_NullConnectionManager_Throws()
        {
            ...
            Assert.ThrowsExactly<ArgumentNullException>(
                () => new GetDashboardErrorRetriesQueryHandlerAsync(null, tableNameHelper));
        }
        ...
        public void Create_NullTableNameHelper_Throws()
        {
            var connectionManager = CreateConnectionManager();
            Assert.ThrowsExactly<ArgumentNullException>(
                () => new GetDashboardErrorRetriesQueryHandlerAsync(connectionManager, null));
        }

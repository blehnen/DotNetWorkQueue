...
namespace DotNetWorkQueue.Transport.LiteDb.Tests.Basic.QueryHandler
{
    ...
    public class GetDashboardMessageBodyQueryHandlerAsyncTests
    {
        ...
        public void Create_Default()
        {
            ...
            Assert.IsNotNull(new GetDashboardMessageBodyQueryHandlerAsync(connectionManager, tableNameHelper));
        }
        ...
        public void Create_NullConnectionManager_Throws()
        {
            ...
            Assert.ThrowsExactly<ArgumentNullException>(
                () => new GetDashboardMessageBodyQueryHandlerAsync(null, tableNameHelper));
        }
        ...
        public void Create_NullTableNameHelper_Throws()
        {
            var connectionManager = CreateConnectionManager();
            Assert.ThrowsExactly<ArgumentNullException>(
                () => new GetDashboardMessageBodyQueryHandlerAsync(connectionManager, null));
        }

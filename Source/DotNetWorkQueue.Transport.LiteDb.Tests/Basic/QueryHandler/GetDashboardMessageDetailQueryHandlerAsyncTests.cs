...
namespace DotNetWorkQueue.Transport.LiteDb.Tests.Basic.QueryHandler
{
    ...
    public class GetDashboardMessageDetailQueryHandlerAsyncTests
    {
        ...
        public void Create_Default()
        {
            ...
            Assert.IsNotNull(new GetDashboardMessageDetailQueryHandlerAsync(connectionManager, tableNameHelper));
        }
        ...
        public void Create_NullConnectionManager_Throws()
        {
            ...
            Assert.ThrowsExactly<ArgumentNullException>(
                () => new GetDashboardMessageDetailQueryHandlerAsync(null, tableNameHelper));
        }
        ...
        public void Create_NullTableNameHelper_Throws()
        {
            var connectionManager = CreateConnectionManager();
            Assert.ThrowsExactly<ArgumentNullException>(
                () => new GetDashboardMessageDetailQueryHandlerAsync(connectionManager, null));
        }

...
namespace DotNetWorkQueue.Transport.LiteDb.Tests.Basic.QueryHandler
{
    ...
    public class GetDashboardMessagesQueryHandlerAsyncTests
    {
        ...
        public void Create_Default()
        {
            ...
            Assert.IsNotNull(new GetDashboardMessagesQueryHandlerAsync(connectionManager, tableNameHelper));
        }
        ...
        public void Create_NullConnectionManager_Throws()
        {
            ...
            Assert.ThrowsExactly<ArgumentNullException>(
                () => new GetDashboardMessagesQueryHandlerAsync(null, tableNameHelper));
        }
        ...
        public void Create_NullTableNameHelper_Throws()
        {
            var connectionManager = CreateConnectionManager();
            Assert.ThrowsExactly<ArgumentNullException>(
                () => new GetDashboardMessagesQueryHandlerAsync(connectionManager, null));
        }

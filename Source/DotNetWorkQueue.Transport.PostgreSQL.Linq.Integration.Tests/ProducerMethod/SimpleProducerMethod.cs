...
namespace DotNetWorkQueue.Transport.PostgreSQL.Linq.Integration.Tests.ProducerMethod
{
    ...
    public class SimpleProducerMethod
    {
        ...
        DataRow(100, false, true, true, true, true, false, false, LinqMethodTypes.Dynamic, false),
         DataRow(100, false, true, false, true, true, true, false, LinqMethodTypes.Dynamic, false),
         DataRow(100, true, true, false, false, false, true, true, LinqMethodTypes.Dynamic, false),
#endif

...
namespace DotNetWorkQueue.Transport.PostgreSQL.Linq.Integration.Tests.ProducerMethod
{
    ...
    public class SimpleProducerMethodBatch
    {
        ...
        [InlineData(100, true, true, false, false, false,  false, false, LinqMethodTypes.Compiled, false),
         ...
         InlineData(500, false, true,  false, true, true,  true, false, LinqMethodTypes.Dynamic, false),
         InlineData(500, true, true,  false, false, false,  false, true, LinqMethodTypes.Dynamic, false),
#endif        
         ...
         InlineData(500, false, true,  false, true, true, true, false, LinqMethodTypes.Compiled, false),
         InlineData(500, true, true, false, false, false, false, true, LinqMethodTypes.Compiled, false),

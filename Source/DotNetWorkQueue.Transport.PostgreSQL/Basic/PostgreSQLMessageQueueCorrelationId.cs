...
namespace DotNetWorkQueue.Transport.PostgreSQL.Basic
{
    ...
    /// </summary>
    public class PostgreSqlMessageQueueCorrelationId: ICorrelationId
    {
        private Guid _id;
        /// <summary>
        /// Initializes a new instance of the <see cref="PostgreSqlMessageQueueCorrelationId"/> class.
        /// </summary>
        /// <param name="id">The identifier.</param>
        public PostgreSqlMessageQueueCorrelationId(Guid id)
        {
            _id = id;

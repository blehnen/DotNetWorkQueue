...
namespace DotNetWorkQueue.Transport.PostgreSQL.Basic
{
    ...
    /// </summary>
    internal class PostgreSqlMessageQueueSend : ISendMessages
    {
        ...
        #region Constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="PostgreSqlMessageQueueSend" /> class.
        /// </summary>
        ...
        public PostgreSqlMessageQueueSend(ISentMessageFactory sentMessageFactory,
        ...
        public IQueueOutputMessage Send(IMessage messageToSend, IAdditionalMessageData data)
        {
            try
            {
                ...
                return new QueueOutputMessage(_sentMessageFactory.Create(new PostgreSqlMessageQueueId(id), data.CorrelationId));
            }
            ...
            try
            {
                ...
                Parallel.ForEach(messages, m =>
                {
                    try
                    {
                        ...
                        rc.Add(
                            new QueueOutputMessage(_sentMessageFactory.Create(new PostgreSqlMessageQueueId(id),
            ...
            try
            {
                ...
                foreach (var m in messages)
                {
                    try
                    {
                        ...
                        rc.Add(new QueueOutputMessage(_sentMessageFactory.Create(new PostgreSqlMessageQueueId(id), m.MessageData.CorrelationId)));
                    }
                    catch (Exception error)
                    {

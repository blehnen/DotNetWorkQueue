...
{
    internal class PostgreSqlMessageQueueSendHeartBeat : ISendHeartBeat 
    {
        ...
        #region Constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="PostgreSqlMessageQueueSendHeartBeat" /> class.
        /// </summary>
        /// <param name="commandHandler">The command handler.</param>
        public PostgreSqlMessageQueueSendHeartBeat(ICommandHandlerWithOutput<SendHeartBeatCommand, DateTime?> commandHandler)
        {

...
namespace DotNetWorkQueue.Transport.PostgreSQL.Basic.QueryHandler
{
    ...
    internal class GetPendingDelayedCountHandler : IQueryHandler<GetPendingDelayedCountQuery, long>
    {
        ...
        public GetPendingDelayedCountHandler(PostgreSqlCommandStringCache commandCache,
        ...
        public long Handle(GetPendingDelayedCountQuery query)
        {
            using (var connection = new NpgsqlConnection(_connectionInformation.ConnectionString))
            {
                ...
                using (var command = connection.CreateCommand())
                {
                    ...
                    command.CommandText = _commandCache.GetCommand(PostgreSqlCommandStringTypes.GetPendingDelayCount);

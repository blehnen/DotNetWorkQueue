...
namespace DotNetWorkQueue.Transport.PostgreSQL.Basic.QueryHandler
{
    ...
    internal class GetPendingExcludeDelayCountQueryHandler : IQueryHandler<GetPendingExcludeDelayCountQuery, long>
    {
        ...
        public GetPendingExcludeDelayCountQueryHandler(PostgreSqlCommandStringCache commandCache,
        ...
        public long Handle(GetPendingExcludeDelayCountQuery query)
        {
            using (var connection = new NpgsqlConnection(_connectionInformation.ConnectionString))
            {
                ...
                using (var command = connection.CreateCommand())
                {
                    ...
                    command.CommandText = _commandCache.GetCommand(PostgreSqlCommandStringTypes.GetPendingExcludeDelayCount);

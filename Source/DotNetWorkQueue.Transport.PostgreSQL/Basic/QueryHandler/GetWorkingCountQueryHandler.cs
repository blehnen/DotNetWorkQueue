...
namespace DotNetWorkQueue.Transport.PostgreSQL.Basic.QueryHandler
{
    ...
    internal class GetWorkingCountQueryHandler : IQueryHandler<GetWorkingCountQuery, long>
    {
        ...
        public GetWorkingCountQueryHandler(PostgreSqlCommandStringCache commandCache,
        ...
        public long Handle(GetWorkingCountQuery query)
        {
            using (var connection = new NpgsqlConnection(_connectionInformation.ConnectionString))
            {
                ...
                {
                    command.CommandText = _commandCache.GetCommand(PostgreSqlCommandStringTypes.GetWorkingCount);

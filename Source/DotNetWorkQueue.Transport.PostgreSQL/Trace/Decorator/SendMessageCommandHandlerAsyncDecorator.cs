...
namespace DotNetWorkQueue.Transport.PostgreSQL.Trace.Decorator
{
    ...
    public class SendMessageCommandHandlerAsyncDecorator : ICommandHandlerWithOutputAsync<SendMessageCommand, long>
    {
        ...
        public SendMessageCommandHandlerAsyncDecorator(ICommandHandlerWithOutputAsync<SendMessageCommand, long> handler, ActivitySource tracer, IHeaders headers, IConnectionInformation connectionInformation)
        {
            _handler = handler;
            _tracer = tracer;
            _headers = headers;

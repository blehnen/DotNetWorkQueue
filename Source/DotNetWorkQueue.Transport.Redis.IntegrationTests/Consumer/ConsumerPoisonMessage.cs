...
namespace DotNetWorkQueue.Transport.Redis.IntegrationTests.Consumer
{
    ...
    public class ConsumerPoisonMessage
    {
        ...
        InlineData(10, 30, 5, ConnectionInfoTypes.Linux, false),
        InlineData(50, 40, 20, ConnectionInfoTypes.Linux, false),
            InlineData(1, 20, 1, ConnectionInfoTypes.Windows, false),
        InlineData(10, 30, 5, ConnectionInfoTypes.Windows, false),
        InlineData(50, 40, 20, ConnectionInfoTypes.Windows, false),
            InlineData(1, 20, 1, ConnectionInfoTypes.Linux, true),
        InlineData(10, 30, 5, ConnectionInfoTypes.Linux, true),
        InlineData(50, 40, 20, ConnectionInfoTypes.Linux, true),
            InlineData(1, 20, 1, ConnectionInfoTypes.Windows, true),
        InlineData(10, 30, 5, ConnectionInfoTypes.Windows, true),
        InlineData(50, 40, 20, ConnectionInfoTypes.Windows, true)]

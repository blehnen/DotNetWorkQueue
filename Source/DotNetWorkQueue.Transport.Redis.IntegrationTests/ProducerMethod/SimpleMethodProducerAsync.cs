...
namespace DotNetWorkQueue.Transport.Redis.IntegrationTests.ProducerMethod
{
    ...
    public class SimpleMethodProducerAsync
    {
        ...
        InlineData(10000, true, false, ConnectionInfoTypes.Linux, LinqMethodTypes.Dynamic),
        InlineData(10000, false, false, ConnectionInfoTypes.Linux, LinqMethodTypes.Dynamic),
        ...
        InlineData(10000, true, false, ConnectionInfoTypes.Windows, LinqMethodTypes.Dynamic),
        InlineData(10000, false, false, ConnectionInfoTypes.Windows, LinqMethodTypes.Dynamic),
        ...
        InlineData(10000, true, false, ConnectionInfoTypes.Linux, LinqMethodTypes.Compiled),
        InlineData(10000, false, false, ConnectionInfoTypes.Linux, LinqMethodTypes.Compiled),
        ...
        InlineData(10000, true, false, ConnectionInfoTypes.Windows, LinqMethodTypes.Compiled),
        InlineData(10000, false, false, ConnectionInfoTypes.Windows, LinqMethodTypes.Compiled),
           ...
           LinqMethodTypes linqMethodTypes)
        {
                        ...
                        serviceRegister => serviceRegister.Register(() => logProvider, LifeStyles.Singleton)))
            {
                try
                {
                    await producer.RunTest<RedisQueueInit>(queueName,
                        connectionString, interceptors, messageCount, logProvider, Helpers.GenerateData,
                        Helpers.Verify, batchSending, 0, id, linqMethodTypes);
                }
                finally
                {
                    using (

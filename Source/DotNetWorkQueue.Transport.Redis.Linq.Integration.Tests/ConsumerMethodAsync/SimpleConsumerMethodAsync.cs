...
namespace DotNetWorkQueue.Transport.Redis.Linq.Integration.Tests.ConsumerMethodAsync
{
    ...
    public class SimpleConsumerMethodAsync
    {
        ...
        [Theory]
        [InlineData(500, 1, 400, 10, 5, 5, 1, ConnectionInfoTypes.Linux, LinqMethodTypes.Compiled),
         ...
         InlineData(500, 0, 180, 10, 5, 0, 1, ConnectionInfoTypes.Linux, LinqMethodTypes.Compiled),
            InlineData(500, 1, 400, 10, 5, 5, 1, ConnectionInfoTypes.Windows, LinqMethodTypes.Compiled),
         ...
         InlineData(500, 0, 180, 10, 5, 0, 1, ConnectionInfoTypes.Windows, LinqMethodTypes.Compiled),
            InlineData(500, 1, 400, 10, 5, 5, 1, ConnectionInfoTypes.Linux, LinqMethodTypes.Dynamic),
         ...
         InlineData(500, 0, 180, 10, 5, 0, 1, ConnectionInfoTypes.Linux, LinqMethodTypes.Dynamic),
            InlineData(500, 1, 400, 10, 5, 5, 1, ConnectionInfoTypes.Windows, LinqMethodTypes.Dynamic),
         ...
         InlineData(500, 0, 180, 10, 5, 0, 1, ConnectionInfoTypes.Windows, LinqMethodTypes.Dynamic)]

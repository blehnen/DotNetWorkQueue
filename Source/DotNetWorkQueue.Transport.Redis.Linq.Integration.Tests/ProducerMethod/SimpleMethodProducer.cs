...
namespace DotNetWorkQueue.Transport.Redis.Linq.Integration.Tests.ProducerMethod
{
    ...
    public class SimpleMethodProducer
    {
        ...
        [InlineData(1000, true, false, false, false, ConnectionInfoTypes.Linux, LinqMethodTypes.Dynamic),
         ...
         InlineData(10000, true, false, false, false, ConnectionInfoTypes.Linux, LinqMethodTypes.Dynamic),
         InlineData(10000, false, false, false, false, ConnectionInfoTypes.Linux, LinqMethodTypes.Dynamic),
         ...
         InlineData(10000, true, false, false, false, ConnectionInfoTypes.Windows, LinqMethodTypes.Dynamic),
         InlineData(10000, false, false, false, false, ConnectionInfoTypes.Windows, LinqMethodTypes.Dynamic),
         ...
         InlineData(10000, true, false, false, false, ConnectionInfoTypes.Linux, LinqMethodTypes.Compiled),
         InlineData(10000, false, false, false, false, ConnectionInfoTypes.Linux, LinqMethodTypes.Compiled),
         ...
         InlineData(10000, true, false, false, false, ConnectionInfoTypes.Windows, LinqMethodTypes.Compiled),
         InlineData(10000, false, false, false, false, ConnectionInfoTypes.Windows, LinqMethodTypes.Compiled),

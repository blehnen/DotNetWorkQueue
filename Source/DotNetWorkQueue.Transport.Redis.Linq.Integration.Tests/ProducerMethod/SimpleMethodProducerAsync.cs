...
namespace DotNetWorkQueue.Transport.Redis.Linq.Integration.Tests.ProducerMethod
{
    ...
    public class SimpleMethodProducerAsync
    {
        ...
        InlineData(5000, true, false, ConnectionInfoTypes.Linux, LinqMethodTypes.Dynamic),
        InlineData(5000, false, false, ConnectionInfoTypes.Linux, LinqMethodTypes.Dynamic),
        ...
        InlineData(5000, true, false, ConnectionInfoTypes.Windows, LinqMethodTypes.Dynamic),
        InlineData(5000, false, false, ConnectionInfoTypes.Windows, LinqMethodTypes.Dynamic),
        ...
        InlineData(5000, true, false, ConnectionInfoTypes.Linux, LinqMethodTypes.Compiled),
        InlineData(5000, false, false, ConnectionInfoTypes.Linux, LinqMethodTypes.Compiled),
        ...
        InlineData(5000, true, false, ConnectionInfoTypes.Windows, LinqMethodTypes.Compiled),
        InlineData(5000, false, false, ConnectionInfoTypes.Windows, LinqMethodTypes.Compiled),

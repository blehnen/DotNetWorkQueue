...
namespace DotNetWorkQueue.Transport.Redis.Tests.Basic.CommandHandler
{
    public class DashboardUpdateMessageBodyCommandHandlerTests
    {
        ...
        public void Create_Default()
        {
            ...
            Assert.NotNull(new DashboardUpdateMessageBodyCommandHandler(connection, redisNames));
        }
        ...
        public void Create_NullConnection_Throws()
        {
            ...
            Assert.Throws<ArgumentNullException>(
                () => new DashboardUpdateMessageBodyCommandHandler(null, redisNames));
        }
        ...
        public void Create_NullRedisNames_Throws()
        {
            var connection = Substitute.For<IRedisConnection>();
            Assert.Throws<ArgumentNullException>(
                () => new DashboardUpdateMessageBodyCommandHandler(connection, null));
        }
    }
}

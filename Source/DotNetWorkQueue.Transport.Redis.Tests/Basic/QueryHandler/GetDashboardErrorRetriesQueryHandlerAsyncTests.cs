...
namespace DotNetWorkQueue.Transport.Redis.Tests.Basic.QueryHandler
{
    ...
    public class GetDashboardErrorRetriesQueryHandlerAsyncTests
    {
        ...
        public void Create_Default()
        {
            ...
            Assert.IsNotNull(new GetDashboardErrorRetriesQueryHandlerAsync(connection, redisNames, serializer));
        }
        ...
        public void Create_NullConnection_Throws()
        {
            ...
            Assert.ThrowsExactly<ArgumentNullException>(
                () => new GetDashboardErrorRetriesQueryHandlerAsync(null, redisNames, serializer));
        }
        ...
        public void Create_NullRedisNames_Throws()
        {
            ...
            var serializer = Substitute.For<IInternalSerializer>();
            Assert.ThrowsExactly<ArgumentNullException>(
                () => new GetDashboardErrorRetriesQueryHandlerAsync(connection, null, serializer));
        }
        ...
        public void Create_NullSerializer_Throws()
        {
            ...
            var redisNames = Substitute.For<RedisNames>(Substitute.For<IConnectionInformation>());
            Assert.ThrowsExactly<ArgumentNullException>(
                () => new GetDashboardErrorRetriesQueryHandlerAsync(connection, redisNames, null));
        }
    }
}

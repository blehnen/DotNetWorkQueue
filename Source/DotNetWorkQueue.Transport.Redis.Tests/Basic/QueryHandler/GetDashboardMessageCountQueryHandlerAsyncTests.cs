...
namespace DotNetWorkQueue.Transport.Redis.Tests.Basic.QueryHandler
{
    ...
    public class GetDashboardMessageCountQueryHandlerAsyncTests
    {
        ...
        public void Create_Default()
        {
            ...
            Assert.IsNotNull(new GetDashboardMessageCountQueryHandlerAsync(connection, redisNames));
        }
        ...
        public void Create_NullConnection_Throws()
        {
            ...
            Assert.ThrowsExactly<ArgumentNullException>(
                () => new GetDashboardMessageCountQueryHandlerAsync(null, redisNames));
        }
        ...
        public void Create_NullRedisNames_Throws()
        {
            var connection = Substitute.For<IRedisConnection>();
            Assert.ThrowsExactly<ArgumentNullException>(
                () => new GetDashboardMessageCountQueryHandlerAsync(connection, null));
        }
    }
}

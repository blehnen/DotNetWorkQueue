...
namespace DotNetWorkQueue.Transport.Redis.Tests.Basic.QueryHandler
{
    ...
    public class GetDashboardStatusCountsQueryHandlerAsyncTests
    {
        ...
        public void Create_Default()
        {
            ...
            Assert.IsNotNull(new GetDashboardStatusCountsQueryHandlerAsync(connection, redisNames));
        }
        ...
        public void Create_NullConnection_Throws()
        {
            ...
            Assert.ThrowsExactly<ArgumentNullException>(
                () => new GetDashboardStatusCountsQueryHandlerAsync(null, redisNames));
        }
        ...
        public void Create_NullRedisNames_Throws()
        {
            var connection = Substitute.For<IRedisConnection>();
            Assert.ThrowsExactly<ArgumentNullException>(
                () => new GetDashboardStatusCountsQueryHandlerAsync(connection, null));
        }
    }
}

...
namespace DotNetWorkQueue.Transport.Redis.Trace.Decorator
{
    ...
    /// </remarks>
    public class RollbackMessageCommandHandlerDecoratorAsync : ICommandHandlerAsync<RollbackMessageCommand<string>>
    {
        private readonly ICommandHandlerAsync<RollbackMessageCommand<string>> _handler;

        /// <summary>
        /// Initializes a new instance of the <see cref="RollbackMessageCommandHandlerDecoratorAsync"/> class.
        /// </summary>
        /// <param name="handler">The handler.</param>
        public RollbackMessageCommandHandlerDecoratorAsync(ICommandHandlerAsync<RollbackMessageCommand<string>> handler)
        {
            _handler = handler;
        }

...
namespace DotNetWorkQueue.Transport.RelationalDatabase.Tests.Basic.QueryHandler
{
    ...
    public class GetJobLastKnownEventQueryHandlerTests
    {
        ...
        public void Handle_ReaderHasRow_ReturnsReadColumnValue()
        {
            ...
            fixture.PrepareQuery.Received(1).Handle(query, fixture.Command, CommandStringTypes.GetJobLastKnownEvent);
        ...
        private TestFixture CreateFixture()
        {
            ...
            var handler = new GetJobLastKnownEventQueryHandler(prepareQuery, dbConnectionFactory, readColumn);
        ...
        {
            public GetJobLastKnownEventQueryHandler Handler { get; set; }
            public IPrepareQueryHandler<GetJobLastKnownEventQuery, DateTimeOffset> PrepareQuery { get; set; }

...
namespace DotNetWorkQueue.Transport.RelationalDatabase.Basic.Command
{
    ...
    /// </summary>
    public class CreateJobTablesCommand<TTableType>
        where TTableType: ITable
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateJobTablesCommand{TTableType}"/> class.
        /// </summary>

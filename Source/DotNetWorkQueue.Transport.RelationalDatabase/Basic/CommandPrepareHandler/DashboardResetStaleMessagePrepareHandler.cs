...
{
    /// <inheritdoc />
    public class DashboardResetStaleMessagePrepareHandler : IPrepareCommandHandler<DashboardResetStaleMessageCommand>
    {
        private readonly CommandStringCache _commandCache;

        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardResetStaleMessagePrepareHandler"/> class.
        /// </summary>
        /// <param name="commandCache">The command cache.</param>
        public DashboardResetStaleMessagePrepareHandler(CommandStringCache commandCache)
        {

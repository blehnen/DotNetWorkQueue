...
{
    /// <inheritdoc />
    public class DashboardUpdateMessageBodyPrepareHandler : IPrepareCommandHandler<DashboardUpdateMessageBodyCommand>
    {
        private readonly CommandStringCache _commandCache;

        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardUpdateMessageBodyPrepareHandler"/> class.
        /// </summary>
        /// <param name="commandCache">The command cache.</param>
        public DashboardUpdateMessageBodyPrepareHandler(CommandStringCache commandCache)
        {
        ...
        public void Handle(DashboardUpdateMessageBodyCommand command, IDbCommand dbCommand, CommandStringTypes commandType)
        {
            if (!dbCommand.Parameters.Contains("@QueueId"))
            {
                ...
                param.Value = command.Body;
                dbCommand.Parameters.Add(param);

                param = dbCommand.CreateParameter();
                param.ParameterName = "@Headers";
                param.DbType = DbType.Binary;
                param.Value = command.Headers;
                dbCommand.Parameters.Add(param);
            }

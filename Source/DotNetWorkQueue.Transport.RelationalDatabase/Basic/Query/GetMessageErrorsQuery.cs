...
namespace DotNetWorkQueue.Transport.RelationalDatabase.Basic.Query
{
    ...
    /// </summary>
    public class GetMessageErrorsQuery : IQuery<Dictionary<string, int>>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMessageErrorsQuery"/> class.
        /// </summary>
        /// <param name="queueId">The queue identifier.</param>
        public GetMessageErrorsQuery(long queueId)
        {

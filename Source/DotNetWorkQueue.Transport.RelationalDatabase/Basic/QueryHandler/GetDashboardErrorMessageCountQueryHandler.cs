...
{
    internal class GetDashboardErrorMessageCountQueryHandler : IQueryHandler<GetDashboardErrorMessageCountQuery, long>
    {
        ...
        public GetDashboardErrorMessageCountQueryHandler(
        ...
        public long Handle(GetDashboardErrorMessageCountQuery query)
        {

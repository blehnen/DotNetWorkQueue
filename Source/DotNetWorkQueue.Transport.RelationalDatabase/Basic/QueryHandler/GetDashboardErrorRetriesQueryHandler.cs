...
{
    internal class GetDashboardErrorRetriesQueryHandler : IQueryHandler<GetDashboardErrorRetriesQuery, IReadOnlyList<DashboardErrorRetry>>
    {
        private readonly IPrepareQueryHandler<GetDashboardErrorRetriesQuery, IReadOnlyList<DashboardErrorRetry>> _prepareQuery;
        private readonly IDbConnectionFactory _dbConnectionFactory;
        private readonly IReadColumn _readColumn;

        public GetDashboardErrorRetriesQueryHandler(
        ...
        public IReadOnlyList<DashboardErrorRetry> Handle(GetDashboardErrorRetriesQuery query)
        {

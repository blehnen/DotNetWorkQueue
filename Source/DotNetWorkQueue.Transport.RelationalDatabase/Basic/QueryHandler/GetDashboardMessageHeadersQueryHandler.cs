...
{
    internal class GetDashboardMessageHeadersQueryHandler : IQueryHandler<GetDashboardMessageHeadersQuery, DashboardMessageHeaders>
    {
        ...
        public GetDashboardMessageHeadersQueryHandler(
        ...
        public DashboardMessageHeaders Handle(GetDashboardMessageHeadersQuery query)
        {

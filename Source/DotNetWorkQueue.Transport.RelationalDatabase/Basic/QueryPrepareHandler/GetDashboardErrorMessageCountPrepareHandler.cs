...
{
    internal class GetDashboardErrorMessageCountPrepareHandler : IPrepareQueryHandler<GetDashboardErrorMessageCountQuery, long>
    {
        private readonly CommandStringCache _commandCache;

        public GetDashboardErrorMessageCountPrepareHandler(CommandStringCache commandCache)
        {

...
{
    internal class GetDashboardErrorRetriesPrepareHandler : IPrepareQueryHandler<GetDashboardErrorRetriesQuery, IReadOnlyList<DashboardErrorRetry>>
    {
        private readonly CommandStringCache _commandCache;

        public GetDashboardErrorRetriesPrepareHandler(CommandStringCache commandCache)
        {

...
{
    internal class GetDashboardJobsPrepareHandler : IPrepareQueryHandler<GetDashboardJobsQuery, IReadOnlyList<DashboardJob>>
    {
        private readonly CommandStringCache _commandCache;

        public GetDashboardJobsPrepareHandler(CommandStringCache commandCache)
        {

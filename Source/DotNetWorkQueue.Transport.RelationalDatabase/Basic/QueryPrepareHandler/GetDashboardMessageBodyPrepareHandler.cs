...
{
    internal class GetDashboardMessageBodyPrepareHandler : IPrepareQueryHandler<GetDashboardMessageBodyQuery, DashboardMessageBody>
    {
        private readonly CommandStringCache _commandCache;

        public GetDashboardMessageBodyPrepareHandler(CommandStringCache commandCache)
        {

...
{
    internal class GetDashboardMessageHeadersPrepareHandler : IPrepareQueryHandler<GetDashboardMessageHeadersQuery, DashboardMessageHeaders>
    {
        private readonly CommandStringCache _commandCache;

        public GetDashboardMessageHeadersPrepareHandler(CommandStringCache commandCache)
        {

...
{
    internal class GetDashboardStatusCountsPrepareHandler : IPrepareQueryHandler<GetDashboardStatusCountsQuery, DashboardStatusCounts>
    {
        private readonly CommandStringCache _commandCache;

        public GetDashboardStatusCountsPrepareHandler(CommandStringCache commandCache)
        {

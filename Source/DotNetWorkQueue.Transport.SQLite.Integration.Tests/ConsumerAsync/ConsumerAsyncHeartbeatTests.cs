...
using DotNetWorkQueue.IntegrationTests.Shared.ConsumerAsync.Implementation;
    ...
    public class ConsumerAsyncHeartbeatTests
    {
        ...
        public void Run(int messageCount, bool inMemoryDb)
        {
            using (var connectionInfo = new IntegrationConnectionInfo(inMemoryDb))
            {
                ...
                var test = new ConsumerAsyncHeartbeatTest();
                test.Run<SqLiteMessageQueueInit, FakeMessage, SqLiteMessageQueueCreation>(
                    ...
                    x =>
                    {
                        Helpers.SetOptions(x, false, true, false, false, true, true, false);
                    },

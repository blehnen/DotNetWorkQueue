...
namespace DotNetWorkQueue.Transport.SQLite.Integration.Tests.ConsumerAsync
{
    ...
    public class ConsumerAsyncPoisonMessage
    {
        ...
        [InlineData(1, 60, 1, 1, 0, true, false),
         InlineData(50, 60, 10, 2, 2, false, false),
                    ...
                    try
                    {
                            ...
                            )
                        {
                            ...
                            consumer.RunConsumer<SqLiteMessageQueueInit>(queueConnection,
                                ...
                                timeOut, readerCount, queueSize, messageCount, TimeSpan.FromSeconds(30), TimeSpan.FromSeconds(35), "second(*%10)", null, enableChaos, new CreationScopeNoOp());

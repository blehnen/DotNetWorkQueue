...
namespace DotNetWorkQueue.Transport.SQLite.Integration.Tests.ConsumerMethodAsync
{
    [Collection("SQLite")]
    public class SimpleMethodConsumerAsync
    {
        ...
        [Theory]
        [InlineData(500, 1, 400, 10, 5, 5, 1, true, LinqMethodTypes.Dynamic),
         InlineData(50, 5, 200, 10, 1, 2, 1, true, LinqMethodTypes.Dynamic),
         InlineData(10, 5, 180, 7, 1, 1, 1, true, LinqMethodTypes.Dynamic),
         InlineData(500, 0, 180, 10, 5, 0, 1, true, LinqMethodTypes.Dynamic),
         InlineData(500, 1, 400, 10, 5, 5, 1, false, LinqMethodTypes.Dynamic),
         InlineData(50, 5, 200, 10, 1, 2, 1, false, LinqMethodTypes.Dynamic),
         InlineData(10, 5, 180, 7, 1, 1, 1, false, LinqMethodTypes.Dynamic),
         InlineData(500, 0, 180, 10, 5, 0, 1, false, LinqMethodTypes.Dynamic),
         ...
         InlineData(10, 5, 180, 7, 1, 1, 1, true, LinqMethodTypes.Compiled),
         InlineData(500, 0, 180, 10, 5, 0, 1, true, LinqMethodTypes.Compiled),
         InlineData(500, 1, 400, 10, 5, 5, 1, false, LinqMethodTypes.Compiled),
         InlineData(50, 5, 200, 10, 1, 2, 1, false, LinqMethodTypes.Compiled),
         InlineData(10, 5, 180, 7, 1, 1, 1, false, LinqMethodTypes.Compiled),
         InlineData(500, 0, 180, 10, 5, 0, 1, false, LinqMethodTypes.Compiled),
         InlineData(10, 45, 260, 7, 1, 1, 1, false, LinqMethodTypes.Compiled),
         InlineData(10, 45, 260, 7, 1, 1, 1, true, LinqMethodTypes.Compiled)]

...
namespace DotNetWorkQueue.Transport.SQLite.Integration.Tests.ProducerMethod
{
    [Collection("SQLite")]
    public class SimpleMethodProducerBatch
    {
        ...
        [InlineData(1000, true, true, true, false, false, true, false, false, true, LinqMethodTypes.Dynamic),
         ...
         InlineData(5000, false, true, true, true, true, true, true, false, true, LinqMethodTypes.Dynamic),
         InlineData(5000, true, true, true, false, false, true, false, true, true, LinqMethodTypes.Dynamic),
         ...
         InlineData(5000, false, true, true, true, true, true, true, false, false, LinqMethodTypes.Dynamic),
         InlineData(5000, true, true, true, false, false, true, false, true, false, LinqMethodTypes.Dynamic),
         ...
         InlineData(5000, false, true, true, true, true, true, true, false, true, LinqMethodTypes.Compiled),
         InlineData(5000, true, true, true, false, false, true, false, true, true, LinqMethodTypes.Compiled),
         ...
         InlineData(5000, false, true, true, true, true, true, true, false, false, LinqMethodTypes.Compiled),
         InlineData(5000, true, true, true, false, false, true, false, true, false, LinqMethodTypes.Compiled)]
        public void Run(
            int messageCount,
            bool interceptors,

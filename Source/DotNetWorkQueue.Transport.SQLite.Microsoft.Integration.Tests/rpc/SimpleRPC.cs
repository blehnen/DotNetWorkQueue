...
namespace DotNetWorkQueue.Transport.SQLite.Microsoft.Integration.Tests.rpc
{
    [Collection("SQLite")]
    public class SimpleRpc
    {
        [Theory]
        [InlineData(50, 1, 120, 1, false, true),
         InlineData(50, 1, 120, 1, true, true),
         InlineData(30, 0, 120, 1, false, false),
         InlineData(30, 0, 120, 1, true, false)]

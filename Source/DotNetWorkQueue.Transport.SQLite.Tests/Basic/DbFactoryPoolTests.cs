...
namespace DotNetWorkQueue.Transport.SQLite.Tests.Basic
{
    ...
    /// </summary>
    public class DbFactoryPoolTests : IDisposable
    {
        private string _dir;

        public DbFactoryPoolTests()
        {
        ...
        public void DisposingARentedConnection_ReturnsItInsteadOfClosingIt()
        {
            ...
            second.State.Should().Be(ConnectionState.Open, "the second rent should have reused the returned connection, still open");
        }
        ...
        public void DisposingTheFactory_ReleasesTheDatabaseFile()
        {
            ...
            File.Delete(path);
            Assert.False(File.Exists(path), "the database file should be deletable once the factory is disposed");
        }
        ...
        public void CreateConnection_AfterDispose_Throws()
        {
            ...
            Assert.Throws<ObjectDisposedException>(() => factory.CreateConnection(connectionString, false));
        }
        ...
        public void InMemoryDatabases_AreNotPooled()
        {
            ...
            Assert.IsAssignableFrom<SQLiteConnection>(connection);
        }
        ...
        public void AConnectionDisposedBeforeItsTransaction_IsNotReturnedToThePool()
        {
            ...
            Convert.ToInt64(check.ExecuteScalar()).Should().Be(0L,
        ...
        public void DisposingARentedConnectionTwice_IsSafe()
        {
            ...
            Assert.Equal(ConnectionState.Open, a.State);
        }
    }
}

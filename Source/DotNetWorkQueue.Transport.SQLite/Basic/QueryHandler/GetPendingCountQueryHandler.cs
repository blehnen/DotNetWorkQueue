...
namespace DotNetWorkQueue.Transport.SQLite.Basic.QueryHandler
{
    ...
    internal class GetPendingCountQueryHandler : IQueryHandler<GetPendingCountQuery, long>
    {
        ...
        public GetPendingCountQueryHandler(SqLiteCommandStringCache commandCache, 
        ...
        public long Handle(GetPendingCountQuery query)
        {
            ...
            using (var connection = new SQLiteConnection(_connectionInformation.ConnectionString))
            {
                ...
                {
                    command.CommandText = _commandCache.GetCommand(SqLiteCommandStringTypes.GetPendingCount);

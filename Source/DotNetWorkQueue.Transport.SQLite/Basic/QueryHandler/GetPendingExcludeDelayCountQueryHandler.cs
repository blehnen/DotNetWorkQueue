...
namespace DotNetWorkQueue.Transport.SQLite.Basic.QueryHandler
{
    ...
    internal class GetPendingExcludeDelayCountQueryHandler : IQueryHandler<GetPendingExcludeDelayCountQuery, long>
    {
        ...
        public GetPendingExcludeDelayCountQueryHandler(SqLiteCommandStringCache commandCache,
        ...
        public long Handle(GetPendingExcludeDelayCountQuery query)
        {
            ...
            using (var connection = new SQLiteConnection(_connectionInformation.ConnectionString))
            {
                ...
                {
                    command.CommandText = _commandCache.GetCommand(SqLiteCommandStringTypes.GetPendingExcludeDelayCount);

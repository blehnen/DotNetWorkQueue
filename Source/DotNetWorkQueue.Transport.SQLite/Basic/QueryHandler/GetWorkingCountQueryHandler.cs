...
namespace DotNetWorkQueue.Transport.SQLite.Basic.QueryHandler
{
    ...
    internal class GetWorkingCountQueryHandler : IQueryHandler<GetWorkingCountQuery, long>
    {
        ...
        public GetWorkingCountQueryHandler(SqLiteCommandStringCache commandCache,
        ...
        public long Handle(GetWorkingCountQuery query)
        {
            ...
            using (var connection = new SQLiteConnection(_connectionInformation.ConnectionString))
            {
                ...
                {
                    command.CommandText = _commandCache.GetCommand(SqLiteCommandStringTypes.GetWorkingCount);

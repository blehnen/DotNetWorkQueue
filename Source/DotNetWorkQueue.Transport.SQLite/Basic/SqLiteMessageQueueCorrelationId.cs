...
namespace DotNetWorkQueue.Transport.SQLite.Basic
{
    ...
    /// </summary>
    public class SqLiteMessageQueueCorrelationId: ICorrelationId
    {
        private Guid _id;
        /// <summary>
        /// Initializes a new instance of the <see cref="SqLiteMessageQueueCorrelationId"/> class.
        /// </summary>
        /// <param name="id">The identifier.</param>
        public SqLiteMessageQueueCorrelationId(Guid id)
        {
            _id = id;

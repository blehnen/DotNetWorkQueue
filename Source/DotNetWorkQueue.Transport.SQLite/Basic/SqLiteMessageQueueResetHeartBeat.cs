...
namespace DotNetWorkQueue.Transport.SQLite.Basic
{
    ...
    /// </summary>
    internal class SqLiteMessageQueueResetHeartBeat : IResetHeartBeat
    {
        ...
        #region Constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="SqLiteMessageQueueResetHeartBeat"/> class.
        /// </summary>
        /// <param name="configuration">The configuration.</param>
        /// <param name="commandHandler">The command handler.</param>
        /// <param name="queryHandler">The query handler.</param>
        public SqLiteMessageQueueResetHeartBeat(QueueConsumerConfiguration configuration, 

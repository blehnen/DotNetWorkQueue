...
namespace DotNetWorkQueue.Transport.SQLite.Trace.Decorator
{
    ...
    /// </remarks>
    public class RollbackMessageCommandHandlerDecoratorAsync : ICommandHandlerAsync<RollbackMessageCommand<long>>
    {
        private readonly ICommandHandlerAsync<RollbackMessageCommand<long>> _handler;

        /// <summary>
        /// Initializes a new instance of the <see cref="RollbackMessageCommandHandlerDecoratorAsync"/> class.
        /// </summary>
        /// <param name="handler">The handler.</param>
        public RollbackMessageCommandHandlerDecoratorAsync(ICommandHandlerAsync<RollbackMessageCommand<long>> handler)
        {
            _handler = handler;
        }

        /// <inheritdoc />
        public async Task HandleAsync(RollbackMessageCommand<long> command)
        {

...
namespace DotNetWorkQueue.Transport.Shared.Basic.Command
{
    ...
    /// </summary>
    public class SetStatusTableStatusCommand<T>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetStatusTableStatusCommand{T}" /> class.
        /// </summary>
        /// <param name="queueId">The queue identifier.</param>
        /// <param name="status">The status.</param>
        public SetStatusTableStatusCommand(T queueId, QueueStatuses status)
        {
            QueueId = queueId;
            Status = status;
        }

...
namespace DotNetWorkQueue.Transport.Shared.Basic
{
    ...
    public class GetHeader<T> : IGetHeader
    {
        #region Member Level Variables
        private readonly IQueryHandler<GetHeaderQuery<T>, IDictionary<string, object>> _commandHandler;
        #endregion

        #region Constructor        
        /// <summary>
        /// Initializes a new instance of the <see cref="GetHeader{T}"/> class.
        /// </summary>

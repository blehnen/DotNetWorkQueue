...
namespace DotNetWorkQueue.Transport.Shared.Basic.Query
{
    ...
    /// </summary>
    public class FindExpiredMessagesToDeleteQuery<T> : IQuery<IEnumerable<T>>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FindExpiredMessagesToDeleteQuery{T}"/> class.
        /// </summary>

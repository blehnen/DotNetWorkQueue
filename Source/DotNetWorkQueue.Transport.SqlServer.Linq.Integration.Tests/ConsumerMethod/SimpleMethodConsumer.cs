...
namespace DotNetWorkQueue.Transport.SqlServer.Linq.Integration.Tests.ConsumerMethod
{
    ...
    public class SimpleMethodConsumer
    {
       ...
       InlineData(2000, 0, 240, 25, false, LinqMethodTypes.Compiled),
       InlineData(2000, 0, 240, 25, true, LinqMethodTypes.Compiled),
       ...
       InlineData(2000, 0, 240, 25, false, LinqMethodTypes.Dynamic),
       InlineData(2000, 0, 240, 25, true, LinqMethodTypes.Dynamic),

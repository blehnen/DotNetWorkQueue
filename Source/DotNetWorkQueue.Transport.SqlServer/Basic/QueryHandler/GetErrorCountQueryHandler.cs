...
namespace DotNetWorkQueue.Transport.SqlServer.Basic.QueryHandler
{
    ...
    internal class GetErrorCountQueryHandler : IQueryHandler<GetErrorCountQuery, long>
    {
        ...
        public GetErrorCountQueryHandler(SqlServerCommandStringCache commandCache,
        ...
        public long Handle(GetErrorCountQuery query)
        {
            using (var connection = new SqlConnection(_connectionInformation.ConnectionString))
            {
                ...
                {
                    command.CommandText = _commandCache.GetCommand(SqlServerCommandStringTypes.GetErrorCount);

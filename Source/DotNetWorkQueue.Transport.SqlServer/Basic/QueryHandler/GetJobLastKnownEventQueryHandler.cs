...
namespace DotNetWorkQueue.Transport.SqlServer.Basic.QueryHandler
{
    ...
    public class GetJobLastKnownEventQueryHandler : IQueryHandler<GetJobLastKnownEventQuery, DateTimeOffset>
    {
        ...
        public GetJobLastKnownEventQueryHandler(SqlServerCommandStringCache commandCache,
        ...
        public DateTimeOffset Handle(GetJobLastKnownEventQuery query)
        {
            using (var connection = new SqlConnection(_connectionInformation.ConnectionString))
            {
                ...
                {
                    command.CommandText = _commandCache.GetCommand(SqlServerCommandStringTypes.GetJobLastKnownEvent);

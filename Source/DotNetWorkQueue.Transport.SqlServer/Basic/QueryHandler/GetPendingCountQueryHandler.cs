...
namespace DotNetWorkQueue.Transport.SqlServer.Basic.QueryHandler
{
    ...
    internal class GetPendingCountQueryHandler : IQueryHandler<GetPendingCountQuery, long>
    {
        ...
        public GetPendingCountQueryHandler(SqlServerCommandStringCache commandCache, 
        ...
        public long Handle(GetPendingCountQuery query)
        {
            using (var connection = new SqlConnection(_connectionInformation.ConnectionString))
            {
                ...
                {
                    command.CommandText = _commandCache.GetCommand(SqlServerCommandStringTypes.GetPendingCount);

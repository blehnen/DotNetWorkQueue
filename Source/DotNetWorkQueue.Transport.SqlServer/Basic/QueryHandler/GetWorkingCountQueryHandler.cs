...
namespace DotNetWorkQueue.Transport.SqlServer.Basic.QueryHandler
{
    ...
    internal class GetWorkingCountQueryHandler : IQueryHandler<GetWorkingCountQuery, long>
    {
        ...
        public GetWorkingCountQueryHandler(SqlServerCommandStringCache commandCache,
        ...
        public long Handle(GetWorkingCountQuery query)
        {
            using (var connection = new SqlConnection(_connectionInformation.ConnectionString))
            {
                ...
                {
                    command.CommandText = _commandCache.GetCommand(SqlServerCommandStringTypes.GetWorkingCount);

...
namespace DotNetWorkQueue.Transport.SqlServer.Basic
{
    ...
    /// </summary>
    public class SqlServerMessageQueueId: IMessageId
    {
        private readonly long _id;
        /// <summary>
        /// Initializes a new instance of the <see cref="SqlServerMessageQueueId"/> class.
        /// </summary>
        /// <param name="id">The identifier.</param>
        public SqlServerMessageQueueId(long id)
        {
            _id = id;

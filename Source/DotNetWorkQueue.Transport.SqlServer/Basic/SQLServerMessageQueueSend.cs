...
namespace DotNetWorkQueue.Transport.SqlServer.Basic
{
    ...
    /// </summary>
    internal class SqlServerMessageQueueSend : ISendMessages
    {
        ...
        #region Constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="SqlServerMessageQueueSend" /> class.
        /// </summary>
        ...
        public SqlServerMessageQueueSend(ISentMessageFactory sentMessageFactory,
        ...
        public IQueueOutputMessage Send(IMessage messageToSend, IAdditionalMessageData data)
        {
            try
            {
                ...
                return new QueueOutputMessage(_sentMessageFactory.Create(new SqlServerMessageQueueId(id), data.CorrelationId));
            }
            ...
            try
            {
                ...
                Parallel.ForEach(messages, m =>
                {
                    try
                    {
                        ...
                        rc.Add(
                            new QueueOutputMessage(_sentMessageFactory.Create(new SqlServerMessageQueueId(id),
            ...
            try
            {
                ...
                foreach (var m in messages)
                {
                    try
                    {
                        ...
                        rc.Add(new QueueOutputMessage(_sentMessageFactory.Create(new SqlServerMessageQueueId(id), m.MessageData.CorrelationId)));
                    }
                    catch (Exception error)
                    {

...
namespace DotNetWorkQueue.Transport.SqlServer.Basic
{
    ...
    /// </summary>
    internal class SqlServerQueueStatusProvider: QueueStatusProviderBase
    {
        private readonly Lazy<SqlServerMessageQueueTransportOptions> _options;
        private readonly IInternalSerializer _serializer;
        private readonly SqlServerMessageQueueStatusQueries _queries;

        /// <summary>
        /// Initializes a new instance of the <see cref="SqlServerQueueStatusProvider" /> class.
        /// </summary>
        ...
        public SqlServerQueueStatusProvider(IConnectionInformation connectionInformation,
            IGetTimeFactory getTimeFactory,
            ISqlServerMessageQueueTransportOptionsFactory optionsFactory,
            IInternalSerializer serializer, 
            SqlServerMessageQueueStatusQueries queries) : base(connectionInformation, getTimeFactory)
        {

...
namespace DotNetWorkQueue.Messages
{
    ...
    /// </summary>
    public class MessageHandlerRegistrationAsync : IMessageHandlerRegistrationAsync
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageHandlerRegistrationAsync"/> class.
        /// </summary>
        /// <param name="generateMessage">The generate message.</param>
        public MessageHandlerRegistrationAsync(IGenerateReceivedMessage generateMessage)
        {
        ...
        public void Set<T>(Func<IReceivedMessage<T>, IWorkerNotification, Task> messageAction) where T : class
        {

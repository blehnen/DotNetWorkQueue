...
namespace DotNetWorkQueue.Transport.Memory
{
    ...
    public static class ConfigurationExtensionsForIAdditionalMessageData
    {
        ...
        {
            data.SetSetting("MemoryMessageQueueDelay", delay);
        }
        /// <summary>
    ...
    public static class ConfigurationExtensionsForQueueConfigurationReceive
    {
        ...
        /// The options.
        /// </value>
        public static TransportOptions Options(this QueueConfigurationReceive configuration)
        {
            if (configuration.AdditionalConfiguration.TryGetSetting("MemoryTransportOptions", out dynamic options))
            {
                return options;
            }
    ...
    public static class ConfigurationExtensionsForQueueConfigurationSend
    {
        ...
        /// The options.
        /// </value>
        public static TransportOptions Options(this QueueConfigurationSend configuration)
        {
            if (configuration.AdditionalConfiguration.TryGetSetting("MemoryTransportOptions", out dynamic options))
            {
                return options;

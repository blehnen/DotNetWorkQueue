        ...
        static void Main(string[] args)
        {
                    ...
                    options => Injectors.SetOptions(options, SharedConfiguration.EnableChaos)))
            {
                using (var createQueue =
                    jobQueueCreation.GetQueueCreation<LiteDbJobQueueCreation>(queueConnection))
                {
...
q) Quit");
                        ...
                        try
                        {
                            ...
                            {
                                case 'a':
                                    job1 = scheduler.AddUpdateJob<LiteDbMessageQueueInit, LiteDbJobQueueCreation>("test job1",
                                        queueConnection,
                                    ...
                                    break;
                                case 'b':
                                    job2 = scheduler.AddUpdateJob<LiteDbMessageQueueInit, LiteDbJobQueueCreation>("test job2",
                                       queueConnection,
                                        "min(*)",
                                    ...
                                    break;
                                case 'c':
                                    job3 = scheduler.AddUpdateJob<LiteDbMessageQueueInit, LiteDbJobQueueCreation>("test job3",
                                        queueConnection,
                                        "sec(30)",

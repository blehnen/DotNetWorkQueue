                    ...
                    , options => Injectors.SetOptions(options, SharedConfiguration.EnableChaos)))
            {
                    ...
                    jobQueueCreation.GetQueueCreation<SqlServerJobQueueCreation>(queueName, connectionString))
                {
                    ...
                    var result = createQueue.CreateJobSchedulerQueue(serviceRegister =>
                        Injectors.AddInjectors(log, SharedConfiguration.EnableTrace, SharedConfiguration.EnableMetrics, SharedConfiguration.EnableCompression, SharedConfiguration.EnableEncryption, "SQLServerScheduler", serviceRegister), queueName, connectionString, 
